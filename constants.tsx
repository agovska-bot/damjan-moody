...
const iconClasses = "w-10 h-10 mx-auto mb-2 transition-colors duration-300";
...
export const FEATURES: Feature[] = [
  {
    ...
    inactiveClasses: 'bg-lovely-purple-200 text-lovely-purple-600 hover:bg-lovely-purple-400 hover:text-white',
  ...
  },
  {
    ...
    inactiveClasses: 'bg-aqua-teal-200 text-aqua-teal-600 hover:bg-aqua-teal-400 hover:text-white',
  ...
  },
  {
    ...
    inactiveClasses: 'bg-sky-blue-200 text-sky-blue-600 hover:bg-sky-blue-400 hover:text-white',
  ...
  },
  {
    ...
    inactiveClasses: 'bg-soft-pink-200 text-soft-pink-600 hover:bg-soft-pink-400 hover:text-white',
  ...
  },
  {
    ...
    inactiveClasses: 'bg-happy-green-200 text-happy-green-600 hover:bg-happy-green-400 hover:text-white',
  ...
  },
  {
    ...
    inactiveClasses: 'bg-playful-yellow-200 text-playful-yellow-600 hover:bg-playful-yellow-400 hover:text-white',
